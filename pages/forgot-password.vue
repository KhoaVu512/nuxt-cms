		...
		<div class="col-span-6 ">
			<div class="grid grid-rows-[200px,repeat(auto-fill,minmax(15%,100px)),300px] ">
				...
				<div class="flex row-start-2 justify-center">
					<div class="">
						<div class="text-[24px] mb-1 ml-1 mr-1">Forgot password?</div>
						<div class="mt-1 mb-1 ml-1 text-[#5A5A5A]">No worriest! Just enter your email and we’ll send <br> you a reset password link.</div>
						<div>
