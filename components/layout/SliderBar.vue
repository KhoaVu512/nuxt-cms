			...
			<ul class="space-y-2">
				...
				<li>
					...
					>
						...
						<nuxt-link to="test" class="flex-1 ml-3 whitespace-nowrap">test</nuxt-link>
						<span
				...
				<li>
					...
					>
						...
						<nuxt-link to="new-comment" class="flex-1 ml-3 whitespace-nowrap">new comment</nuxt-link>
						<span
				...
				<li v-if="user"  class="hidden">
					...
					>
						...
						<nuxt-link to="login" class="flex-1 ml-3 whitespace-nowrap">Sign In</nuxt-link>
					</a>
				</li>
				<li v-if="user"  class="hidden">
					<a
